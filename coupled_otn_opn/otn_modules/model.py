...
# Deep into our model and set each weight and bias
def append_params(params, module, prefix):
    for child in module.children():
        for k,p in child._parameters.items():   # Key, Param
...
if __name__ == "__main__":
    a = MDNet()
    b = Variable(torch.rand((1, 3, 107, 107)))
    print (a._modules)
    a(b)
    print ('-------------------')
    for name, m in a.named_children():
